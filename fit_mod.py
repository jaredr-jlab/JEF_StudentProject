...
def fitFunc(histoFileName):
    ...
    for index, key in enumerate(histoFile.GetListOfKeys()):
        ...
        # ----------------------------------------------------------
        c.SaveAs("./fit_module/fit_plots/" + kname + ".pdf")
        ...
        with open("./fit_module/parameter_values/main_sigmaL.csv", 'a+') as f_sigmal:
            f_sigmal.write("{},{},0,{}\n".format(mass[index], sigmal, ersigmal))
        with open("./fit_module/parameter_values/main_sigmaR.csv", 'a+') as f_sigmar:
